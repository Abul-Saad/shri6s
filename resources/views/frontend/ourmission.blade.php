        ...
        <section id="center_column" class="col-md-9">
          <div class="clearfix"></div>
            <div class="bannercontainer banner-fullwidth">
          			 <img class="lazy img-responsive" src="{{url('frontend/assets/images/gaushala/our1.jpg')}}" style="width: 100%; height: 300px;" alt=""/>
            </div>
                ...
                <div class="widget-html block">
                  <div class="block_content">
                    <div class="row">
                        <h3>Our Mission</h3>
                        <br>
                      <p style="text-align: center; font-size: 18px; font-style: italic;margin: 20px;">At Shri Sant Saptarishi Satogun Sampuran Sanskar Trust, we are dedicated to the welfare and protection of cows. Our mission is to provide a safe, nurturing, and healthy environment for cows, where they can live peacefully and be well cared for. We believe in the cultural, spiritual, and environmental significance of cows and strive to promote their well-being.
                    </p>
