              ...
              <div class="widget col-lg-12 col-md-12 col-sm-12 col-xs-12 col-sp-12 nopadding nobackground noborder" >
                <div class="widget-html block">
                  <div class="block_content">
                    <div class="row">
                      <h4 style="font-size: 30px;"> Kindly Donate Us for Social Activites. </h4>
                      <p>&nbsp;</p>
                      
                      <img src="{{url('frontend/assets/images/shripic/download1.jpg')}}" alt="" height="70px" >
                      <h1 style="font-size: 20px;font-weight: 100px;">Bank Name : State Bank of India</h1>
                      <p style="font-size: 15px;"> <strong> Account Holder Name : </strong> Shri sant saptrishi satogun sampuran sanskar trust</p>
                      <p style="font-size: 15px; font-weight: 100px;"> <strong> Branch : </strong> Prabhat nagar</p>
                      <p style="font-size: 15px;"> <strong> Account Number: </strong>  42437610236</p> 
                      <p style="font-size: 15px;"> <strong> IFSC Code: </strong> SBIN0031011</p>
                  
 
                      <img src="{{url('frontend/assets/images/shripic/Bank-1.jpg')}}" alt="" height="100px" >
                      <img src="{{url('frontend/assets/images/qrcode.jpg')}}" alt="" style="height: 350px;">
