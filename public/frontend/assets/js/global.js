...
function display(view) {
  ...
  if (view == "list") {
    ...
    $(".product_list > div").each(function (index, element) {
      html = "";
      html =
        '<div class="product-container product-block text-center ImageWrapper"><div class="row">';
      html +=
    ...
    $(".product_list > div").each(function (index, element) {
      html = "";
      html +=
        '<div class="product-container product-block text-center ImageWrapper">';
      html +=
